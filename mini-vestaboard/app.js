(function(){
  ...
  var BUILD_VERSION = "3.2.2";

  var BUILD_TOKEN = "20260918-v322";
  ...
  function smartContext(
    ...
    if(
      ...
      return "Rain is likely today — an umbrella may be worth grabbing.";
    ...
    if(
      ...
      return "It is cold outside — bundle up before heading out.";
    ...
    if(
      ...
      return "It is a hot one — keep water nearby.";
  ...
  async function fetchCalendar(){
    ...
    try{
      ...
      if(
        ...
        CFG.calendar.googleCalendarId &&

        CFG.calendar.googleCalendarApiKey
  ...
  function prepareFilmAudio(
    ...
    /*
      Always begin muted so autoplay can never
      block the picture.

      finishVideoStart() calls syncFilmAudio()
  ...
  function markMediaProgress(video){
  ...
  function playCurrentMedia(force){
    ...
    /*
      Start every film muted first.

      This is the most reliable path on Fire/Silk,
      Chrome and Safari.

      Once playback succeeds,
      finishVideoStart() calls syncFilmAudio().
    */
      ...
      promise
        ...
        .catch(
          function(e){
            ...
            console.warn(
              "First media start attempt failed",
              src,
              e
            );
    ...
    window.addEventListener(
      ...
      function(){
        ...
        navigator.serviceWorker
          ...
          .register(
            "service-worker.js?v=20260918-v322"
          )
